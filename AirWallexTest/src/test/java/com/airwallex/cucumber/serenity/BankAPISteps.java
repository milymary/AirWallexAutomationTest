...
public class BankAPISteps extends ReusableSpecifications {
	...
	public void postPayload(String payment_method, String bank_country_code, String account_name, String account_number,
		...
		//data calls the payload creation testdata file, which generates the payload for the request
		reqSpec =SerenityRest.given().spec(requestSpecification())
									 .body(data.AddBankDetailsPayload(payment_method, bank_country_code, account_name, account_number, swift_code, bsb, aba));
